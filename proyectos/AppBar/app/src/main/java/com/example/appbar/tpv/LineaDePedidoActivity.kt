...
//---------------------------------------------------------------------------------------------------
        ...
        //Inicializamos el spinner uy le asignamos valores por defecto
...
//---------------------------------------------------------------------------------------------------
    ...
    /**
     * Método que guarda el pedido realizado en la base de datos de Firebase
     */
...
//---------------------------------------------------------------------------------------------------
    ...
    /**
     * Colocamos los datos traidos a lo largo de los distintos Recycler en sus campos
     */
...
//---------------------------------------------------------------------------------------------------
    ...
    /**
     * Método que recoge los datos necesarios de los distintos Recycler por los que se ha pasado
     */
...
//---------------------------------------------------------------------------------------------------
    ...
    /**
     * Método del spinner que asigna a una variable el valor seleccionado y permite guardar el pedido
     */
