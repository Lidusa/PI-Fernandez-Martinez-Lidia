...
//---------------------------------------------------------------------------------------------------
        ...
        //Inicializamos el spinner con la lista de las familias
...
//---------------------------------------------------------------------------------------------------
    ...
    /**
     * Método que comprueba que el campo no está vacio
     * @return true o false
     */
...
//---------------------------------------------------------------------------------------------------
    ...
    /**
     * Método que guarda el artículo en la base de datos de Firebase
     */
...
//---------------------------------------------------------------------------------------------------
    ...
    /**
     * Método del spinner que coloca la imagen de la familia según la opción seleccionada
     */
