...
//---------------------------------------------------------------------------------------------------
    ...
    /**
     * Asignamos el adapter al layout
     */
...
//---------------------------------------------------------------------------------------------------
    ...
    /**
     * Indicamos que queremos mostrar en el recycler
     */
...
//---------------------------------------------------------------------------------------------------
    ...
    /**
     * Método que permite eliminar el elemento seleccionado del recycler y la base de datos
     */
...
//---------------------------------------------------------------------------------------------------
    ...
    /**
     * Método que permite obtener el id del elemento seleccionado
     */
